...
- 讓 refresh job 列出所有 active trip，逐一重跑該旅次範圍內的 lodging/map enrichment 並更新 Mongo canonical data。
...
### New Capabilities
- `scheduled-trip-refresh`: 支援定期刷新 active trip 中仍在考慮的房源資料，優先更新價格與可售狀態，並讓 Mongo-backed 旅次頁直接反映最新結果。
...
- Affected code: `app/map_enrichment_job.py`, `app/map_enrichment/*`, `app/config.py`, `tests/*`, `README.md`
